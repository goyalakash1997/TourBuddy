...
public class shoppingdetails extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ShoppingMalls adapter = new ShoppingMalls(this,R.layout.shoppingmalls, words);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
             ...
             /*   Intent intent=new Intent(shoppingdetails.this,rate.class);
                ...
                GetNearbyPlaceDetails nearbyPlaceDetails=new GetNearbyPlaceDetails(shoppingdetails.this);
