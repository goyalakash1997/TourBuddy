...
//public class ShoppingMalls {
    public class ShoppingMalls extends ArrayAdapter<HashMap<String,String>> {
        private Context mContext;
        int mresource;
        private int mColorResourceId;
        public ShoppingMalls(Context context, int resource, ArrayList<HashMap<String,String>> words) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (listItemView == null) {
                listItemView = LayoutInflater.from(getContext()).inflate(
                        R.layout.shoppingmalls, parent, false);
            }
