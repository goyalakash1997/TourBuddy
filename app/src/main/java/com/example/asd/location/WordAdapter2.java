...
public class WordAdapter2 extends ArrayAdapter<HashMap<String,String>> {
    private Context mContext;
    int mresource;
    private int mColorResourceId;
    public WordAdapter2(Context context, int resource, ArrayList<HashMap<String,String>> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.details_item2, parent, false);
        }
